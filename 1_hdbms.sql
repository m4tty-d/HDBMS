...
-- 105.
SELECT o.ORDER_ID, to_char(o.ORDER_DATE, 'DS HH24:MM:SS') as "Order Date", c.CUST_FIRST_NAME || ' ' || c.CUST_LAST_NAME as "Customer Name"
  FROM oe.ORDERS o
...
BEGIN
  HDBMS18.MEGOLDAS_FELTOLT(106, 'SELECT p.PRODUCT_ID, p. PRODUCT_NAME, p. PRODUCT_DESCRIPTION
  FROM oe.PRODUCT_INFORMATION p
LEFT JOIN oe.ORDER_ITEMS oi
    ON p.PRODUCT_ID = oi.PRODUCT_ID
WHERE ORDER_ID IS NULL
...
-- 107.
CREATE OR REPLACE VIEW INCOME_AND_SPENDING AS
